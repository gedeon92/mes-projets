...
<head>
    ...
    <title>EduVote - Modifier une Filière</title>
            ...
            <form action="{{ route('filieres.update', $filiere) }}" method="POST">
                ...
                <div class="form-section">
                    ...
                    <div class="mb-3">
                        ...
                        <div class="form-text text-muted">
                            Modifiez le nom de la filière si nécessaire.
                        </div>
                    </div>
                </div>
                ...
                <div class="form-section">
                    ...
                    <div class="mb-3">
                        ...
                        <select class="form-select @error('departement_id') is-invalid @enderror" 
                            ...
                            @foreach($departements as $departement)
                                <option value="{{ $departement->id }}" 
                                        {{ old('departement_id', $filiere->departement_id) == $departement->id ? 'selected' : '' }}>
                                    {{ $departement->nom }}
                                </option>
                            @endforeach
                        </select>
                        ...
                        @enderror
                        <div class="form-text text-muted">
                            Modifiez le département de rattachement si nécessaire.
                        </div>
                    </div>
                </div>
